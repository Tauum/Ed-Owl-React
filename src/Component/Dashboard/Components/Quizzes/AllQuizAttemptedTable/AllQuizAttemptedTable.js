                ...
                <ul className="responsive-table">
                    ...
                    {parentToChild.map((SubmittedQuiz, index)=>( 
                        <li className="table-Row" key={index}>
                            <div className="col col-1" data-label="Title">{SubmittedQuiz.quiz.title}</div>
                            <div className="col col-2" data-label="Date">{SubmittedQuiz.generatedDate}</div>
                            <div className="col col-3" data-label="Time limit">{SubmittedQuiz.timeLimit}</div>
                            <div className="col col-4" data-label="Value">{SubmittedQuiz.score}</div>
